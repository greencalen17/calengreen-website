CREATE TABLE IF NOT EXISTS `experiences` (
    ...
    `name`            varchar(100)  NOT NULL                    COMMENT 'The of the experience',
    `description`     text          DEFAULT NULL                COMMENT 'The description of the experience',
    `hyperlink`       varchar(255)  DEFAULT NULL                COMMENT 'The link to more info about the experience',
